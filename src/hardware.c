...
void hardware_init_gpio(void) {
    ...
    GPIO_InitStruct.Pin = PLAYER1_ENCODER_PUSH_PIN | PLAYER1_MENU_BUTTON_PIN 
                        | PLAYER1_BACK_BUTTON_PIN | PLAYER1_TAP_BUTTON_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    // player 2 button pins on port a (input with pull-up)
